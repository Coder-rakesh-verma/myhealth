    ...
    <div style={{ fontFamily:"'Segoe UI',system-ui,sans-serif",background:"linear-gradient(135deg,#f0eaff,#e8f5f0)",minHeight:"100vh",display:"flex",alignItems:"center",justifyContent:"center",padding:20 }}>
      ...
      <div style={{ width:"100%",maxWidth:440 }}>
        ...
        <div style={{ textAlign:"center",marginBottom:24 }}>
          ...
          <h1 style={{ margin:0,fontSize:22,fontFamily:"'Georgia',serif",color:"#1e1b4b" }}>Join <span style={{ color:"#7c3aed" }}>MyHealth</span></h1>
          <p style={{ margin:"6px 0 0",color:"#9ca3af",fontSize:14 }}>Create your free account today</p>
        </div>
